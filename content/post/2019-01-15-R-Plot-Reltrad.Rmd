...
library(devtools)
urldata= "https://github.com/thebigbird/R_Stata_Reltrad/edit/master/ReltradGSS.R"
source_url(urldata)
```
...
#Convert a factor to a number, but preserve the labels
relTable$year = as.numeric(levels(relTable$year))[relTable$year]
#for the error bars
