...
Now, here is the full code to create _reltrad_ in R. The original R source code for the _reltrad_ recoding can be accessed from GitHub [here](https://github.com/thebigbird/academic/blob/master/content/post/ReltradGSS.R).Feel free to fork this code and add your own file path.
